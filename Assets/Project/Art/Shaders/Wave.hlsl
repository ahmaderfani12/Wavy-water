...
void WavePos_float(float3 _pos, float3 _w1Porp, float2 _dir1, float3 _w2Porp, float2 _dir2, float3 _w3Porp, float2 _dir3, float _time, out float3 _newPos, out float _maxHeight)
{
...
void WavePos_float(float3 _pos, float3 _w1Porp, float2 _dir1, float3 _w2Porp, float2 _dir2, float3 _w3Porp, float2 _dir3, float _time, out float3 _newPos)
{
